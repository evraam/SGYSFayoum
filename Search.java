...
public class Search extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mBookList=(RecyclerView)view.findViewById(R.id.search_book_list);
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        SearchView searchView = new SearchView(((Drawel) getActivity()).getSupportActionBar().getThemedContext());
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String newText) {
                FirebaseRecyclerAdapter<book,Search.blogViewHolder> firebaseRecyclerAdapter=new FirebaseRecyclerAdapter<book, Search.blogViewHolder>(
                        book.class,
                        R.layout.reviews_row,
                        Search.blogViewHolder.class,
                        mDatabase.orderByChild("bookTitle").startAt(newText).endAt(newText+"\uf8ff")

                ) {
                    @Override
                    protected void populateViewHolder(Search.blogViewHolder viewHolder, book model, int position) {
